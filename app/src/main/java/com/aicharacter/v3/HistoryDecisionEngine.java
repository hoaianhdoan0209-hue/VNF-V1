...
public final class HistoryDecisionEngine {private HistoryDecisionEngine(){}
 ...
 public static double personality(WorldState s,String intention,boolean weatherRisk,Map<String,Double>out){
  double v=0;if("reflect".equals(intention)||"observe".equals(intention)){double x=(s.personality.curiosity-.5)*16;out.put("personality_curiosity",x);v+=x;}
 ...
 public static double habit(WorldState s,String action,String place,Map<String,Double>out){HabitState h=s.habits.get(action+"@"+place);double v=h==null?0:h.strength*11;out.put("habit",v);return v;}
}