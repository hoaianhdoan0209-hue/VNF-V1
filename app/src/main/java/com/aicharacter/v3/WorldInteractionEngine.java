...
public final class WorldInteractionEngine {
 ...
 public static boolean interact(WorldState s,WorldObject o,String action){if(o==null||!o.enabled||!o.interactable||!PhysicalInteraction.inRange(s,o))return false;String id=o.id;
  if("REST".equals(action)&&(o.tags.contains("rest")||o.tags.contains("sit"))){s.haruActivity=o.tags.contains("shelter")?"resting under shelter":"sitting and resting";s.body.energy=Math.min(100,s.body.energy+.08);remember(s,o,"rested here for a while","rest");return true;}
