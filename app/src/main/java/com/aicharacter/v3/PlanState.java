...
public final class PlanState{
 ...
 public String origin="LEGACY",candidateGoalId="",triggerEvidenceId="",questionId="",reasoningHypothesisId="",predictionId="",causalAdaptationId="",adaptationPolicy="",causalExperimentId="",experimentStrategy="";
