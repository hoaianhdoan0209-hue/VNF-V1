...
public final class ThoughtState {public String subject,trigger,possibleIntention;public double uncertainty,emotionalWeight;public long createdAt;public final List<String> relatedMemories=new ArrayList<>();
 ...
 public boolean isCurrent(long now,String activeIntention){if(createdAt<=0||now<createdAt||now-createdAt>180000L)return false;if(possibleIntention==null||possibleIntention.isEmpty())return true;return activeIntention!=null&&!activeIntention.isEmpty()&&possibleIntention.equals(activeIntention);}
