...
public final class HaruAbstractConceptEngine{
 ...
 private static void learnDelta(WorldState s,String key,AbstractMeaningState.Snapshot a,AbstractMeaningState.Snapshot b,double weight,long now){
  ...
  boolean voluntary=contains(a.intention,"observe","explore","study","compare","reflect")||contains(b.intention,"observe","explore","study","compare","reflect");if(voluntary&&b.curiosity>38)reinforce(s,key,INTERESTING,cl(.25+b.curiosity/130.0)*weight,"she kept choosing to pay attention here while curiosity stayed active",now);
 }
