...
public final class WildlifeManifestationEngine {
 ...
 private static double traitMotion(SpeciesEvolutionCatalog.Species s){if(s==null)return.28;double v=.28;if(s.locomotion.contains("flight")||s.locomotion.contains("drift")||s.locomotion.contains("skate")||s.locomotion.contains("undulate"))v+=.22;if(s.locomotion.contains("hop")||s.locomotion.contains("scuttle"))v+=.14;if(s.lifeCycle.contains("dormant")||s.lifeCycle.contains("long-slow"))v-=.12;return clamp(v);}
