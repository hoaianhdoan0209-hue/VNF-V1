...
public final class VoiceController implements TextToSpeech.OnInitListener {
    ...
    private final Activity activity; private final Listener listener; private TextToSpeech tts; private SpeechRecognizer recognizer; private boolean enabled=false;
