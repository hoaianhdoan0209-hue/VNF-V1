...
public final class NeedState {
 ...
 public static NeedState evaluate(WorldState s){
  ...
  n.rest=(100-s.body.energy)*.65+s.body.sleepiness*.55+s.body.pain*.5+s.body.injuryBurden()*18+cold*12+heat*10+breath*9;
  n.physicalComfort=wet*55+rainExposure*42+s.body.pain*.25+Math.max(0,35-s.body.energy)*.12+cold*48+heat*42+breath*28;
  n.safety=s.body.pain*.8+s.body.injuryBurden()*28+s.emotion.fear*45+rainExposure*18+wet*8+cold*24+heat*22+breath*35+hypoxia*220;
