...
public final class WorldState {
    public static final int SAVE_VERSION = 55;
    ...
    public final List<EmotionEpisodeState> emotionEpisodes=new ArrayList<>();
    public String currentIntention="observe_lake";
    public long lastProactiveAt=0L;
    public HaruProactiveSpeechState haruSpeech=new HaruProactiveSpeechState();
    ...
    public DigestiveState digestive=new DigestiveState();
    public HydrationState hydration=new HydrationState();
    public EndocrineState endocrine=new EndocrineState();
    public SkinState skin=new SkinState();
    public ImmuneState immune=new ImmuneState();
    public HerbalismState herbalism=new HerbalismState();
    public LivingWorldState livingWorld=new LivingWorldState();
    public EcologyObservationState ecologyObservation=new EcologyObservationState();
    public PersonalLexiconState personalLexicon=new PersonalLexiconState();
    public PerceptualConceptState perceptualConcepts=new PerceptualConceptState();
    public AbstractMeaningState abstractMeanings=new AbstractMeaningState();
    public NervousState nervous=new NervousState();
    public NeuroModulationState neuroModulation=new NeuroModulationState();
    ...
    public long lastHaruPhysicalMoveAt=0L;
    ...
    public SocialProximityState socialProximity=new SocialProximityState();
    public CatSocialState catSocial=new CatSocialState();
    ...
    // Durable Character/God contract state; separate from God memory, Haru episodic memory and World Definition.
    public CharacterGodState characterGod=new CharacterGodState();
    // Persistent System-Reality child-god/follower ecology. Never merged into Haru mind state.
    public DivineEcologyState divineEcology=new DivineEcologyState();
    ...
    public JSONObject toJson() throws JSONException {
        ...
        JSONObject b=new JSONObject(); for(Map.Entry<String,Double> e:beliefs.entrySet())b.put(e.getKey(),e.getValue()); j.put("beliefs",b); JSONObject bs=new JSONObject(); for(Map.Entry<String,BeliefState> e:beliefStates.entrySet())bs.put(e.getKey(),e.getValue().toJson()); j.put("beliefStates",bs); j.put("emotion",emotion.toJson()); JSONArray ee=new JSONArray();for(EmotionEpisodeState e:emotionEpisodes)ee.put(e.toJson());j.put("emotionEpisodes",ee); j.put("currentIntention",currentIntention); j.put("lastProactiveAt",lastProactiveAt); j.put("haruSpeech",haruSpeech.toJson()); j.put("environment",environment.toJson()); j.put("atmosphere",atmosphere.toJson()); j.put("respiration",respiration.toJson()); j.put("thermal",thermal.toJson()); j.put("bodyInstinct",bodyInstinct.toJson()); j.put("girlPhysics",girlPhysics.toJson(50)); j.put("catPhysics",catPhysics.toJson(4.2)); j.put("bodyRig",bodyRig.toJson()); j.put("musculoskeletal",musculoskeletal.toJson()); j.put("joints",joints.toJson()); j.put("catRig",catRig.toJson()); j.put("circulation",circulation.toJson()); j.put("metabolism",metabolism.toJson()); j.put("digestive",digestive.toJson()); j.put("hydration",hydration.toJson()); j.put("endocrine",endocrine.toJson()); j.put("skin",skin.toJson()); j.put("immune",immune.toJson()); j.put("herbalism",herbalism.toJson()); j.put("livingWorld",livingWorld.toJson()); j.put("ecologyObservation",ecologyObservation.toJson()); j.put("personalLexicon",personalLexicon.toJson()); j.put("perceptualConcepts",perceptualConcepts.toJson()); j.put("abstractMeanings",abstractMeanings.toJson()); j.put("nervous",nervous.toJson()); j.put("neuroModulation",neuroModulation.toJson()); j.put("catNervous",catNervous.toJson()); j.put("catMetabolism",catMetabolism.toJson()); j.put("catRespiration",catRespiration.toJson()); j.put("localizedPain",localizedPain.toJson()); j.put("atmospherePerturbation",atmospherePerturbation.toJson()); j.put("worldRuntime",runtime.toJson()); JSONArray wh=new JSONArray(); for(WorldHistoryEntry e:worldHistory)wh.put(e.toJson()); j.put("worldHistory",wh); JSONArray cl=new JSONArray(); for(CaretakerLogEntry e:caretakerLog)cl.put(e.toJson()); j.put("caretakerLog",cl); JSONArray dr=new JSONArray();for(DeveloperReport e:developerReports)dr.put(e.toJson());j.put("developerReports",dr);j.put("lastCaretakerCheckpoint",lastCaretakerCheckpoint); JSONObject pr=new JSONObject();for(Map.Entry<String,PreferenceState> e:preferences.entrySet())pr.put(e.getKey(),e.getValue().toJson());j.put("preferences",pr);JSONObject ha=new JSONObject();for(Map.Entry<String,HabitState> e:habits.entrySet())ha.put(e.getKey(),e.getValue().toJson());j.put("habits",ha);JSONObject pa=new JSONObject();for(Map.Entry<String,PlaceAssociation> e:placeAssociations.entrySet())pa.put(e.getKey(),e.getValue().toJson());j.put("placeAssociations",pa);JSONObject ce=new JSONObject();for(Map.Entry<String,ContextualPlaceEvidence> e:contextualPlaceEvidence.entrySet())ce.put(e.getKey(),e.getValue().toJson());j.put("contextualPlaceEvidence",ce);j.put("moodState",mood.toJson());j.put("personality",personality.toJson());JSONArray th=new JSONArray();for(ThoughtState t:thoughts)th.put(t.toJson());j.put("thoughts",th);j.put("reedlingState",reedling.toJson());j.put("lastCatSeenAt",lastCatSeenAt);j.put("lastAbsenceMinutes",lastAbsenceMinutes);j.put("reunionContext",reunionContext);j.put("persistentIntentionTarget",persistentIntentionTarget);j.put("intentionStartedAt",intentionStartedAt);j.put("lastHaruPhysicalMoveAt",lastHaruPhysicalMoveAt); j.put("nameState",nameState.toJson()); j.put("catState",catState.toJson()); j.put("catSearch",catSearch.toJson()); j.put("socialProximity",socialProximity.toJson()); j.put("catSocial",catSocial.toJson()); j.put("notificationEvents",NotificationEventQueue.toJson(notificationEvents)); j.put("girlTravel",girlTravel.toJson());j.put("catTravel",catTravel.toJson());j.put("planState",planState.toJson());j.put("routeRuntime",routeRuntime.toJson());JSONArray gi=new JSONArray();for(GodMessage gm:godInbox)gi.put(gm.toJson());j.put("godInbox",gi); j.put("godMemory",godMemory.toJson()); j.put("characterGod",characterGod.toJson()); j.put("divineEcology",divineEcology.toJson()); JSONArray pli=new JSONArray();for(String id:processedLearningIds)pli.put(id);j.put("processedLearningIds",pli); JSONArray cge=new JSONArray();for(String id:committedGodEventIds)cge.put(id);j.put("committedGodEventIds",cge);j.put("worldWetness",worldWetness);j.put("visibility",visibility); return j;
    }
    ...
    public static WorldState fromJson(JSONObject j) throws JSONException {
        ...
        JSONObject bs=j.optJSONObject("beliefStates"); if(bs!=null){java.util.Iterator<String> it=bs.keys();while(it.hasNext()){String key=it.next();JSONObject v=bs.optJSONObject(key);if(v!=null)s.beliefStates.put(key,BeliefState.fromJson(key,v));}} if(s.beliefStates.isEmpty())s.beliefStates.put("cat_intent",new BeliefState("cat_intent","uncertain",s.beliefs.getOrDefault("the_cat_may_be_a_friend",.42))); s.emotion=EmotionState.fromJson(j.optJSONObject("emotion")); JSONArray ee=j.optJSONArray("emotionEpisodes");if(ee!=null)for(int i=0;i<ee.length();i++){JSONObject ex=ee.optJSONObject(i);if(ex!=null)s.emotionEpisodes.add(EmotionEpisodeState.fromJson(ex));} s.currentIntention=j.optString("currentIntention","observe_lake"); s.lastProactiveAt=j.optLong("lastProactiveAt",0L); s.haruSpeech=HaruProactiveSpeechState.fromJson(j.optJSONObject("haruSpeech")); s.environment=EnvironmentState.fromJson(j.optJSONObject("environment")); s.atmosphere=AtmosphereState.fromJson(j.optJSONObject("atmosphere")); s.respiration=RespirationState.fromJson(j.optJSONObject("respiration")); s.thermal=ThermalState.fromJson(j.optJSONObject("thermal")); s.bodyInstinct=BodyInstinctState.fromJson(j.optJSONObject("bodyInstinct")); s.girlPhysics=PhysicsBodyState.fromJson(j.optJSONObject("girlPhysics"),50); s.catPhysics=PhysicsBodyState.fromJson(j.optJSONObject("catPhysics"),4.2); s.bodyRig=BodyRigState.fromJson(j.optJSONObject("bodyRig")); s.musculoskeletal=MusculoskeletalState.fromJson(j.optJSONObject("musculoskeletal")); s.joints=JointConstraintState.fromJson(j.optJSONObject("joints")); s.catRig=CatRigState.fromJson(j.optJSONObject("catRig")); s.circulation=CirculationState.fromJson(j.optJSONObject("circulation")); s.metabolism=MetabolismState.fromJson(j.optJSONObject("metabolism")); s.digestive=DigestiveState.fromJson(j.optJSONObject("digestive")); s.hydration=HydrationState.fromJson(j.optJSONObject("hydration")); s.endocrine=EndocrineState.fromJson(j.optJSONObject("endocrine")); s.skin=SkinState.fromJson(j.optJSONObject("skin")); s.immune=ImmuneState.fromJson(j.optJSONObject("immune")); s.herbalism=HerbalismState.fromJson(j.optJSONObject("herbalism")); s.livingWorld=LivingWorldState.fromJson(j.optJSONObject("livingWorld")); s.ecologyObservation=EcologyObservationState.fromJson(j.optJSONObject("ecologyObservation")); s.personalLexicon=PersonalLexiconState.fromJson(j.optJSONObject("personalLexicon")); s.perceptualConcepts=PerceptualConceptState.fromJson(j.optJSONObject("perceptualConcepts")); s.abstractMeanings=AbstractMeaningState.fromJson(j.optJSONObject("abstractMeanings")); s.nervous=NervousState.fromJson(j.optJSONObject("nervous")); s.neuroModulation=NeuroModulationState.fromJson(j.optJSONObject("neuroModulation")); s.catNervous=CatNervousState.fromJson(j.optJSONObject("catNervous")); s.catMetabolism=CatMetabolismState.fromJson(j.optJSONObject("catMetabolism")); s.catRespiration=CatRespirationState.fromJson(j.optJSONObject("catRespiration")); s.localizedPain=LocalizedPainState.fromJson(j.optJSONObject("localizedPain")); s.atmospherePerturbation=AtmospherePerturbation.fromJson(j.optJSONObject("atmospherePerturbation")); if(version<4 && j.has("weather") && j.optJSONObject("environment")==null){String legacy=j.optString("weather","clear").toUpperCase();s.environment.weather="CLEAR".equals(legacy)||"CLOUDY".equals(legacy)||"RAIN".equals(legacy)?legacy:"CLEAR";} s.runtime=WorldRuntimeState.fromJson(j.optJSONObject("worldRuntime")); if(version<4 && j.optJSONObject("world")!=null){JSONArray oldObjects=j.optJSONObject("world").optJSONArray("objects");if(oldObjects!=null)for(int oi=0;oi<oldObjects.length();oi++){JSONObject oo=oldObjects.optJSONObject(oi);if(oo!=null)s.runtime.objects.put(oo.optString("id"),new WorldRuntimeState.ObjectState((float)oo.optDouble("x"),oo.optBoolean("enabled",true)));}} JSONArray wh=j.optJSONArray("worldHistory");if(wh!=null)for(int i=0;i<wh.length();i++)s.worldHistory.add(WorldHistoryEntry.fromJson(wh.optJSONObject(i))); JSONArray cl=j.optJSONArray("caretakerLog");if(cl!=null)for(int i=0;i<cl.length();i++)s.caretakerLog.add(CaretakerLogEntry.fromJson(cl.optJSONObject(i)));JSONArray dr=j.optJSONArray("developerReports");if(dr!=null)for(int i=0;i<dr.length();i++)s.developerReports.add(DeveloperReport.fromJson(dr.optJSONObject(i)));s.lastCaretakerCheckpoint=j.optString("lastCaretakerCheckpoint",""); JSONObject pr=j.optJSONObject("preferences");if(pr!=null){java.util.Iterator<String> it=pr.keys();while(it.hasNext()){String key=it.next();s.preferences.put(key,PreferenceState.fromJson(key,pr.optJSONObject(key)));}}JSONObject ha=j.optJSONObject("habits");if(ha!=null){java.util.Iterator<String> it=ha.keys();while(it.hasNext()){String key=it.next();s.habits.put(key,HabitState.fromJson(key,ha.optJSONObject(key)));}}JSONObject pa=j.optJSONObject("placeAssociations");if(pa!=null){java.util.Iterator<String> it=pa.keys();while(it.hasNext()){String key=it.next();s.placeAssociations.put(key,PlaceAssociation.fromJson(key,pa.optJSONObject(key)));}}JSONObject ce=j.optJSONObject("contextualPlaceEvidence");if(ce!=null){java.util.Iterator<String> it=ce.keys();while(it.hasNext()){String key=it.next();s.contextualPlaceEvidence.put(key,ContextualPlaceEvidence.fromJson(key,ce.optJSONObject(key)));}}s.mood=MoodState.fromJson(j.optJSONObject("moodState"));s.personality=PersonalityState.fromJson(j.optJSONObject("personality"));JSONArray th=j.optJSONArray("thoughts");if(th!=null)for(int i=0;i<th.length();i++)s.thoughts.add(ThoughtState.fromJson(th.optJSONObject(i)));s.reedling=CreatureState.fromJson(j.optJSONObject("reedlingState"));s.lastCatSeenAt=j.optLong("lastCatSeenAt",s.lastOpenedAt);s.lastAbsenceMinutes=j.optLong("lastAbsenceMinutes",0);s.reunionContext=j.optString("reunionContext","");s.persistentIntentionTarget=j.optString("persistentIntentionTarget","");s.intentionStartedAt=j.optLong("intentionStartedAt",0);s.lastHaruPhysicalMoveAt=j.optLong("lastHaruPhysicalMoveAt",0);
        ...
        s.socialProximity=SocialProximityState.fromJson(j.optJSONObject("socialProximity"));
        s.catSocial=CatSocialState.fromJson(j.optJSONObject("catSocial"));
        NotificationEventQueue.load(j.optJSONArray("notificationEvents"),s.notificationEvents);
        s.girlTravel=TravelState.fromJson(j.optJSONObject("girlTravel"));s.catTravel=TravelState.fromJson(j.optJSONObject("catTravel"));s.planState=PlanState.fromJson(j.optJSONObject("planState"));s.routeRuntime=RouteRuntimeState.fromJson(j.optJSONObject("routeRuntime"));normalizePersistentMotion(s);if(version<9&&"ACTIVE".equals(s.planState.status)){if(s.planState.destination.isEmpty()&&!s.girlTravel.destinationArea.isEmpty())s.planState.destination=s.girlTravel.destinationArea;if(s.planState.plannedAction.isEmpty())s.planState.plannedAction=("seek_shelter".equals(s.planState.intentionId)||"sleep".equals(s.planState.intentionId))?"REST_PROTECT":"reflect".equals(s.planState.intentionId)?"REFLECT":"find_cat".equals(s.planState.intentionId)?"SEARCH_LOCAL":"OBSERVE";s.planState.lastProgressAt=s.lastSavedAt;}JSONArray gi=j.optJSONArray("godInbox");if(gi!=null)for(int i=0;i<gi.length();i++)s.godInbox.add(GodMessage.fromJson(gi.optJSONObject(i))); s.godMemory=GodMemory.fromJson(j.optJSONObject("godMemory")); s.characterGod=CharacterGodState.fromJson(j.optJSONObject("characterGod")); s.divineEcology=DivineEcologyState.fromJson(j.optJSONObject("divineEcology")); JSONArray pli=j.optJSONArray("processedLearningIds");if(pli!=null)for(int i=0;i<pli.length();i++)s.processedLearningIds.add(pli.optString(i)); JSONArray cge=j.optJSONArray("committedGodEventIds");if(cge!=null)for(int i=0;i<cge.length();i++){String id=cge.optString(i,"");if(id.matches("[A-Za-z0-9._-]{1,80}"))s.committedGodEventIds.add(id);} if(version<18){for(WorldHistoryEntry e:s.worldHistory)if(e.eventId!=null&&e.eventId.startsWith("god_world_")){String x=e.eventId.substring("god_world_".length());int cut=x.lastIndexOf("_");if(cut>0)s.committedGodEventIds.add(x.substring(0,cut));}} s.worldWetness=j.optDouble("worldWetness",0);s.visibility=j.optDouble("visibility",1.0);
