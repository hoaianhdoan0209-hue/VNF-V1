...
public final class DopamineModulationEngine {
 ...
 private static double finite01(double v){return Double.isFinite(v)?cl(v):0;}private static double cl(double v){return Double.isFinite(v)?Math.max(0,Math.min(1,v)):0;}
}
